...
| Instantánea | Validada, sin ejecución entrenada | `data/bcs-category-v1`, esquema `bcs-category-snapshot-v1` |
...
No existe una ejecución ni un punto de control NUEVO bajo esta frontera. Hasta contar con un candidato
finalizado, la aceptación se limita a integridad, cobertura completa, trazabilidad y
...
migración. La reversión BCS anterior fue eliminada por autorización; sin candidato
